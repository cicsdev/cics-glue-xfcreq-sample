...
//*  IBM Corp                                                         *
//*-------------------------------------------------------------------*
//DEFFILES JOB (NONE,A1008),'A.EADE',MSGCLASS=H,
...
//SORTWK03    DD SPACE=(6144,(100,100)),UNIT=SYSDA
//SORTIN   DD *
00001 .SMPFILE1.V2 SET B
00002 .SMPFILE1.V2 SET B
00003 .SMPFILE1.V2 SET B
00004 .SMPFILE1.V2 SET B
00005 .SMPFILE1.V2 SET B
00006 .SMPFILE1.V2 SET B
00007 .SMPFILE1.V2 SET B
00008 .SMPFILE1.V2 SET B
00009 .SMPFILE1.V2 SET B
00010 .SMPFILE1.V2 SET B
/*
//SYSIN    DD *
 SORT FIELDS=(1,10,CH,A)
/*
...
//SORTWK03    DD SPACE=(6144,(100,100)),UNIT=SYSDA
//SORTIN   DD *
00001 .SMPFILE2.V2 SET B
00002 .SMPFILE2.V2 SET B
00003 .SMPFILE2.V2 SET B
00004 .SMPFILE2.V2 SET B
00005 .SMPFILE2.V2 SET B
00006 .SMPFILE2.V2 SET B
00007 .SMPFILE2.V2 SET B
00008 .SMPFILE2.V2 SET B
00009 .SMPFILE2.V2 SET B
00010 .SMPFILE2.V2 SET B
/*
//SYSIN    DD *
 SORT FIELDS=(1,10,CH,A)
/*
...
//SORTWK03    DD SPACE=(6144,(100,100)),UNIT=SYSDA
//SORTIN   DD *
00001 .SMPFILE3.V2 SET B
00002 .SMPFILE3.V2 SET B
00003 .SMPFILE3.V2 SET B
00004 .SMPFILE3.V2 SET B
00005 .SMPFILE3.V2 SET B
00006 .SMPFILE3.V2 SET B
00007 .SMPFILE3.V2 SET B
00008 .SMPFILE3.V2 SET B
00009 .SMPFILE3.V2 SET B
00010 .SMPFILE3.V2 SET B
/*
//SYSIN    DD *
 SORT FIELDS=(1,10,CH,A)
/*
